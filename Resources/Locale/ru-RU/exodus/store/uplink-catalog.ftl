...
uplink-mindslave-implant-name = { ent-MindSlaveImplant }

uplink-mindslave-implant-desc = Имплант, превращающий свою цель в раба. Цель не сможет сопротивляться вашим приказам, она полностью в вашей власти!
