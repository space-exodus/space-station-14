...
# UI
station-ai-customization-menu = Кастомизация ядра
station-ai-customization-categories = Категории
station-ai-customization-options = Опционально (выбарть один из)
station-ai-customization-core = Дисплей ядра
station-ai-customization-hologram = Голограммы
# Customizations
station-ai-icon-ai = Машинный призрак
station-ai-icon-angel = Ангел-хранитель
station-ai-icon-bliss = Простые времена
station-ai-icon-clown = Самодурство
station-ai-icon-dorf = Приключения ждут
station-ai-icon-heartline = Сердцебиение
station-ai-icon-smiley = Улыбка
station-ai-hologram-female = Женский образ
station-ai-hologram-male = Мужской образ
station-ai-hologram-face = Летающая голова
station-ai-hologram-cat = Образ кошки
station-ai-hologram-dog = Образ корги
