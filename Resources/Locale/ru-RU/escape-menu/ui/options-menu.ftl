...
ui-options-vp-vertical-fit = Горизонтальная подгонка области просмотра
ui-options-vp-vertical-fit-tooltip =
    Когда включено, область просмотра будет игнорировать горизонтальную ось подгоняя
    размеры под ваш экран. Если ваш экран меньше, чем область просмотра, то
    область просмотра будет обрезана по горизонтальной оси.
...
ui-options-function-toggle-round-end-summary-window = Переключить отображение манифеста конца раунда
