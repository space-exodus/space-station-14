...
ui-options-function-text-backspace = Возврат
ui-options-function-text-delete = Удалить
ui-options-function-text-word-backspace = Возврат слова
...
ui-options-function-multiline-text-submit = Подтвердить многострочный текст
...
ui-options-function-text-scroll-to-bottom = Прокрутить до низа
