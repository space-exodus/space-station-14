...
ui-options-bwoink-sound = Уведомление о сообщении в АХелп
...
ui-options-function-swap-hands-reverse = Поменять руки (справа налево)
...
ui-options-function-editor-toggle-delete = Переключить режим удаления
...
ui-options-function-hotbar-shift1 = 10 слот хотбара Shift+1
ui-options-function-hotbar-shift2 = 11 слот хотбара Shift+2
ui-options-function-hotbar-shift3 = 12 слот хотбара Shift+3
ui-options-function-hotbar-shift4 = 13 слот хотбара Shift+4
ui-options-function-hotbar-shift5 = 14 слот хотбара Shift+5
ui-options-function-hotbar-shift6 = 15 слот хотбара Shift+6
ui-options-function-hotbar-shift7 = 16 слот хотбара Shift+7
ui-options-function-hotbar-shift8 = 17 слот хотбара Shift+8
ui-options-function-hotbar-shift9 = 18 слот хотбара Shift+9
ui-options-function-hotbar-shift0 = 19 слот хотбара Shift+0
...
ui-options-function-loadoutshift1 = 10 страница хотбара (Shift+1)
ui-options-function-loadoutshift2 = 11 страница хотбара (Shift+2)
ui-options-function-loadoutshift3 = 12 страница хотбара (Shift+3)
ui-options-function-loadoutshift4 = 13 страница хотбара (Shift+4)
ui-options-function-loadoutshift5 = 14 страница хотбара (Shift+5)
ui-options-function-loadoutshift6 = 15 страница хотбара (Shift+6)
ui-options-function-loadoutshift7 = 16 страница хотбара (Shift+7)
ui-options-function-loadoutshift8 = 17 страница хотбара (Shift+8)
ui-options-function-loadoutshift9 = 18 страница хотбара (Shift+9)
ui-options-function-loadoutshift0 = 19 страница хотбара (Shift+0)
...
ui-options-function-text-history-prev = Предыдущий элемент истории
ui-options-function-text-history-next = Следующий элемент истории
...
ui-options-admin-player-tab-symbol-setting = Колонка значков антагонистов
ui-options-admin-player-tab-symbol-setting-off = Без значков антагонистов
ui-options-admin-player-tab-symbol-setting-basic = Показ стандартного значка антагонистов
ui-options-admin-player-tab-symbol-setting-specific = Показ подробных значков антагонистов
...
ui-options-admin-player-tab-role-setting-roletypesubtype = Показать тип роли и её подтип
ui-options-admin-player-tab-role-setting-subtyperoletype = Показать подтип роли и её тип
...
ui-options-admin-player-tab-color-setting-both = Раскрашивать всё
ui-options-admin-playerlist-roletype-color = Цветные типы ролей
ui-options-admin-overlay-antag-format = Стиль значка антагонистов
...
ui-options-admin-overlay-antag-format-subtype = Показать подтип антагониста
ui-options-admin-overlay-antag-symbol = Стиль значка антагонистов
ui-options-admin-overlay-antag-symbol-off = Без значков антагонистов
ui-options-admin-overlay-antag-symbol-basic = Показ стандартного значка антагонистов
ui-options-admin-overlay-antag-symbol-specific = Показ подробных значков антагонистов
ui-options-admin-enable-overlay-playtime = Показ времени игры
ui-options-admin-enable-overlay-starting-job = Показ начальной должности
ui-options-admin-overlay-merge-distance = Совмещение дистанций
ui-options-admin-overlay-ghost-fade-distance = Расстояние исчезновения призрачного наложения от курсора
ui-options-admin-overlay-ghost-hide-distance = Расстояние скрытия призрачного наложения от курсора
