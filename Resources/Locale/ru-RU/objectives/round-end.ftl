...
objectives-objective-success = { $objective } | [color={ $markupColor }]Успех![/color] ({TOSTRING($progress, "P0")})
...
objectives-objective-fail = { $objective } | [color={ $markupColor }]Провал![/color] ({TOSTRING($progress, "P0")})
