...
cargo-console-unlock-approved-order-broadcast = [bold]{ $productName } { $orderAmount } шт.[/bold], со стоимостью [bold]{ $cost }[/bold], был одобрен [bold]{ $approverName }, { $approverJob }[/bold]
