...
ent-ClothingNeckCloakSalvagerSupreme = плащ матёрого утилизатора
    .desc = Их носят самые опытные утилизаторы, те, кто освоил космос и сделал добычу полезных ископаемых на астероидах своим ремеслом. Такие вещи не раздают просто так, понимаете?
