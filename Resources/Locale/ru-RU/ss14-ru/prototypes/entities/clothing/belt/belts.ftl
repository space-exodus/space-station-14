...
ent-ClothingBeltMedicalEMT = пояс скорой медицинской помощи
    .desc = Идеально подходит для хранения различной экипировки для оказания экстренной медицинской помощи.
