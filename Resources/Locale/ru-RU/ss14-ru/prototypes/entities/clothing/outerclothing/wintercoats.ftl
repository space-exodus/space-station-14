...
ent-ClothingOuterWinterHoSUnarmored = зимняя куртка главы службы безопасности
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты главы службы безопасноти от переохлаждения, но не от угроз связанных с бригом.
...
ent-ClothingOuterWinterWardenUnarmored = зимняя куртка смотрителя
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты смотрителя от переохлаждения, но не от угроз связанных с бригом.
