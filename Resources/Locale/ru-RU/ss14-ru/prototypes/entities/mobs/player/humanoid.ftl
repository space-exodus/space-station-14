...
ent-DisasterVictimSpawner = жертва катастрофы спавнер
    .desc = { ent-MarkerBase.desc }
ent-HumanoidDisasterVictimRD = жертва катастрофы НР роль призрака
    .desc = { "" }
ent-HumanoidDisasterVictimCMO = жертва катастрофы ГВ роль призрака
    .desc = { ent-HumanoidDisasterVictimRD.desc }
ent-HumanoidDisasterVictimCaptain = жертва катастрофы Капитан роль призрака
    .desc = { ent-HumanoidDisasterVictimRD.desc }
