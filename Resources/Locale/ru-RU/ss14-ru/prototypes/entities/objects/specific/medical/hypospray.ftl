...
ent-StimpackMini = мини-автоинъектор адреналина
    .desc = Уменьшенный инъектор, содержащий дозу стимулятора на 15 секунд.
ent-CombatMedipen = боевой автоинъектор
    .desc = Одноразовый автоинъектор, содержащий химические вещества, восстанавливающие большинство видов повреждений.
ent-Hypopen = ручка
