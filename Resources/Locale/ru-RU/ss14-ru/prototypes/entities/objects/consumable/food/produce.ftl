...
ent-FoodSpacemansTrumpet = труба космонавта
    .desc = Яркий цветок со слабым запахом свежескошенной травы. Прикосновение к цветку через некоторое время приводит к изменению цвета кожи, однако на других поверхностях такого явления не наблюдалось.
