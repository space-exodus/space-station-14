...
ent-FoodDonkpocketStonk = покет прибыли
    .desc = Вкусно, но грустно напоминает о великом крахе 24-го года.
ent-FoodDonkpocketStonkWarm = разогретый покет прибыли
    .desc = { ent-FoodDonkpocketStonk.desc }
ent-FoodDonkpocketCarp = покет карпа
    .desc = Давно забытое издание Donk Pocket, созданное специально для трудолюбивых утилизаторов.
ent-FoodDonkpocketCarpWarm = разогретый покет карпа
