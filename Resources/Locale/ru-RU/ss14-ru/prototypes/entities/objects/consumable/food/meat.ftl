...
ent-FoodMeatTomato = мясо томата-убийцы
    .desc = Ломтик от огромного томата.
...
ent-FoodMeatTomatoCutlet = сырая котлета из томата-убийцы
    .desc = Котлета из куска томата.
