...
ent-CentCommFlippo = позолоченная флиппо Центком
    ...
    .suffix = НЕ МАППИТЬ
ent-SpiderclanFlippo = высокотехнологичная зажигалка
...
ent-HonkCoFlippo = флиппо Honk Co.
    .desc = Скользкая и смехотворная зажигалка производства Honk Co., спрятанная внутри настоящей банановой кожурки.
ent-DonkcoLighter = флиппо Donk Co.
    .desc = Любимя флиппо опытных предателей - овенькая панированная зажигалка от Donk Co. Каким-то образом её можно съесть, пока она горит.
