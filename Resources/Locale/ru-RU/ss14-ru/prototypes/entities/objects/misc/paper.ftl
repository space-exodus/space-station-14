...
ent-PaperSalvageJobLabel = этикетка для запросов утилизации
    .desc = Бумажная этикетка, обозначающая ящик как содержащий груз для выполнения утилизаторских запросов. Продажа ящика с этой этикеткой позволит выполнить запрос.
