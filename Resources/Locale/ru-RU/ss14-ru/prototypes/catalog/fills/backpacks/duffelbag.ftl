...
ent-ClothingBackpackDuffelSyndicateEliteHardsuitBundle = набор элитного скафандра синдиката
    .desc = Содержит элитный скафандр Синдиката, в котором есть еще кое-что.
ent-ClothingBackpackDuffelSyndicateHardsuitExtrasBundle = набор дополнительных вещей скафандров Синдиката
    .desc = Содержит все, что вам необходимо при покупке скафандра.
