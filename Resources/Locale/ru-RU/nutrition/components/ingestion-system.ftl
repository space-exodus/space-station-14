...
ingestion-cant-digest = Вы не сможете съесть { $entity }!
ingestion-cant-digest-other = { CAPITALIZE(SUBJECT($target)) } не сможет съесть { $entity }!
...
edible-slurp = Слёрб. { $flavors }
edible-slurp-other = Слёрб.
