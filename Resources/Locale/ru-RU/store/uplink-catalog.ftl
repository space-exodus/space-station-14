...
uplink-clothing-conducting-gloves-desc = Выглядят точно так же, как изолированные перчатки, но удары током становятся намного сильнее, чем если бы у вас вообще их не было! Лучше всего подарить пассажирам, которые вам действительно не нравятся.
