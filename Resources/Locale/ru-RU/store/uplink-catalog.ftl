...
uplink-reinforcement-radio-ancestor-name = Телепорт подкрепления генетического предка
uplink-reinforcement-radio-ancestor-desc = Призывает специально обученного предка на ваш выбор для помощи вам. В комплект входит сигарета Синдиката.
...
uplink-chameleon-projector-desc = Исчезните на виду, создав вокруг себя голограмму предмета. Не используйте это для игры «Hide and Seek».
# Pointless
