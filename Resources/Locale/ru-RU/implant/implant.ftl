...
implanter-draw-failed-catastrophically = Имплантер ничего не находит и роисходит критический сбой, случайно занося чужой генетический материал под кожу { $user }!
implanter-component-implant-already = { $target } уже имеет { $implant }!

## UI

implanter-set-draw-verb = Ввести имплант
implanter-set-draw-window = Ввести имплант
implanter-set-draw-info = Выберите тип имплантата, который этот имплантер должен удалить:
