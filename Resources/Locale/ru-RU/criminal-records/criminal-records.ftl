...
criminal-records-console-no-record-found = Для выбранного человека не найдено ни одной записи.

## Status

criminal-records-console-status = Статус
criminal-records-status-none = Отсутсует
...
criminal-records-no-history = Судимость этого члена экипажа безупречна.
...
criminal-records-console-wanted = { $name } разыскивается { $officer }: { $reason }.
