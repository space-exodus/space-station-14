...
cmd-mapping-try-grid = Неудалось загрузить как карту. Попытка загрузить как грид...
cmd-mapping-success-load = Создаёт неинициализированную карту из файла { $path } с id { $mapId }.
cmd-mapping-success-load-grid = Создаёт неинициализированную карту из файла { $path } на новую карту с айди { $mapId }.
