...
corvax-hidden-desc-BorgModuleL6C-syndicate = [color=#e31735]Модуль, в который входит пулемёт L6C SAW и пинпоинтер Синдиката.[/color]
corvax-hidden-desc-BorgModuleC20r-syndicate = [color=#e31735]Модуль, в который входит пулемёт C20-r SAW и пинпоинтер Синдиката.[/color]
