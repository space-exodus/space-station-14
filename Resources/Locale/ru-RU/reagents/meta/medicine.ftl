...
reagent-desc-polypyrylium-oligomers = Пурпурная смесь коротких полиэлектролитных звеньев, которую нелегко синтезировать в лаборатории. Лечит удушье и механические повреждения. Останавливает кровотечение.
