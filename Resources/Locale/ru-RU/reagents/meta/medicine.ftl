...
reagent-desc-psicodine = Подавляет тревогу и другие различные формы психических расстройств. Передозировка вызывает галлюцинации и незначительное отравление токсинами.
