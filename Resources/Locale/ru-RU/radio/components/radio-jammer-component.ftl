...
radio-jammer-component-setting-high = Полная
radio-jammer-component-setting-medium = Средняя
radio-jammer-component-setting-low = Низкая
radio-jammer-component-set-message-high = Глушитель связи теперь работает на полную мощность.
radio-jammer-component-set-message-medium = Глушитель связи теперь работает на среднюю мощность.
radio-jammer-component-set-message-low = Глушитель связи теперь работает на низкой мощности.
radio-jammer-component-switch-setting = Переключатель мощности установлен на "[color=yellow]{ $powerLevel }[/color]".
