...
public abstract class SharedInjectorSystem : EntitySystem
{
    ...
    private void AfterInject(Entity<InjectorComponent> injector, EntityUid target, EntityUid user) // Exodus-ThickSyringe | Add user arg
    {
    ...
    private void AfterDraw(Entity<InjectorComponent> injector, EntityUid target, EntityUid user) // Exodus-ThickSyringe
    {
        var mode = injector.Comp.ToggleState; // Exodus-ThickSyringe
