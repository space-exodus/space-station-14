...
public abstract partial class SharedGunSystem : EntitySystem
{
    ...
    public bool AttemptShoot(EntityUid user, EntityUid gunUid, GunComponent gun, EntityCoordinates toCoordinates, EntityUid? target = null)
    {
        ...
        gun.Target = target;
        var result = AttemptShoot(user, gunUid, gun, /* Exodus-NPCsAbilityToTargetEnemy-Start */ target /* Exodus-NPCsAbilityToTargetEnemy-End */);
        gun.ShotCounter = 0;
    ...
    /// </summary>
    public bool AttemptShoot(EntityUid gunUid, GunComponent gun, /* Exodus-NPCsAbilityToTargetEnemy-Start */ EntityUid? target = null /* Exodus-NPCsAbilityToTargetEnemy-End */)
    {
        var coordinates = new EntityCoordinates(gunUid, gun.DefaultDirection);
        gun.ShootCoordinates = coordinates;
        var result = AttemptShoot(gunUid, gunUid, gun, /* Exodus-NPCsAbilityToTargetEnemy-Start */ target /* Exodus-NPCsAbilityToTargetEnemy-End */);
        gun.ShotCounter = 0;
        return result;
    }

    private bool AttemptShoot(EntityUid user, EntityUid gunUid, GunComponent gun, /* Exodus-NPCsAbilityToTargetEnemy-Start */ EntityUid? target = null /* Exodus-NPCsAbilityToTargetEnemy-End */)
    {
