...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU"; // Loki-Localization
        private const string FallbackCulture = "en-US"; // Loki-Localization
        ...
        public void Initialize()
        {
            ...
            var fallbackCulture = new CultureInfo(FallbackCulture); // Loki-Localization

            _loc.LoadCulture(culture);
            _loc.LoadCulture(fallbackCulture); // Loki-Localization
            _loc.SetFallbackCluture(fallbackCulture); // Loki-Localization
