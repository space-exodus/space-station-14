...
/// </summary>
[ByRefEvent]
public record struct FlashAttemptEvent(EntityUid Target, EntityUid? User, EntityUid? Used, float DurationModifier = 1.0f, bool Cancelled = false) : IInventoryRelayEvent
{
