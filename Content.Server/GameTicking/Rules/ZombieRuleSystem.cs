...
public sealed class ZombieRuleSystem : GameRuleSystem<ZombieRuleComponent>
{
    ...
    private void InfectInitialPlayers(ZombieRuleComponent component)
    {
        ...
        if (eligiblePlayers.Count == 0) // Exodus-BePatientZeroOnlyIfYouWish
            return;
        ...
        var initialInfected = _antagSelection.ChooseAntags(initialInfectedCount, eligiblePlayers); // Exodus-BePatientZeroOnlyIfYouWish
