...
public sealed partial class VoiceMaskSystem : EntitySystem
{
    ...
    private void UpdateUI(Entity<VoiceMaskComponent> entity)
    {
        if (_uiSystem.HasUi(entity, VoiceMaskUIKey.Key))
            _uiSystem.SetUiState(entity.Owner, VoiceMaskUIKey.Key, new VoiceMaskBuiState(GetCurrentVoiceName(entity), entity.Comp.VoiceId /* Corvax-TTS */, entity.Comp.VoiceMaskSpeechVerb));
    }
    #endregion
