// Modified by Lokilife, was too lazy to add comments to modifications, still CLA license
using System.Linq;
using System.Net;
...
public sealed class TTSManager
{
    ...
    public async Task<byte[]?> ConvertTextToSpeech(string speaker, string text)
    {
        ...
        try
        {
            ...
            request.RequestUri = new Uri(_apiUrl + $"?speaker={speaker}&ext=ogg&text={HttpUtility.UrlEncode(text)}");
